...
data class PersonalityResponse(
    ...
    fun Traits.toDomainTraits() =
        com.analysis.domain.model.Traits(
    ...
    private fun TraitDetail.toDomainTraitDetail() =
        com.analysis.domain.model.TraitDetail(
            this.score,
            this.detail,
        )
}

fun PersonalityResponse.toPersonality() =
    Personality(
        id = this.id,
