...
internal object GgzzTypography {
    val pretendardBold42 = TextStyle(
    ...
    val pretendardBold28 = TextStyle(
        fontFamily = GgzzFontFamily,
        fontWeight = FontWeight.Bold,
        fontSize = 28.sp,
        lineHeight = 33.4.sp,
    ...
    val pretendardMedium24 = TextStyle(
        fontFamily = GgzzFontFamily,
    ...
    val pretendardMedium14 = TextStyle(
        fontFamily = GgzzFontFamily,
        fontWeight = FontWeight.Medium,
        fontSize = 14.sp,
        lineHeight = 16.7.sp,
    ...
    val pretendardRegular24 = TextStyle(
        fontFamily = GgzzFontFamily,
    ...
    val pretendardRegular8 = TextStyle(
        fontFamily = GgzzFontFamily,
        fontWeight = FontWeight.Light,
        fontSize = 8.sp,
        lineHeight = 9.5.sp,
